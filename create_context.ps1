# --- НАСТРОЙКИ ДЛЯ SCENARIO-LANDING ---
...
$excludeFiles = @(
    "*.env*", "env.local", "yarn.lock", "package-lock.json", "pnpm-lock.yaml",
    "*.log", "tsconfig.tsbuildinfo", "project_context.txt", "create_context.ps1",
    # Медиа-файлы
...
# --- НАЧАЛО СКРИПТА ---
Write-Host "Starting project context creation for scenario-landing..."
